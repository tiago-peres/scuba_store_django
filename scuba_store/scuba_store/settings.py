"""
Django settings for scuba_store project.
...
SECRET_KEY = '0to1xaoa+mjbwqs(mwtbcymx5z&!04*k$kk@19!@)v--r-n&_&'
...
WSGI_APPLICATION = 'scuba_store.wsgi.application'
